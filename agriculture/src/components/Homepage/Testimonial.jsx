...
const Testimonial = () => {
  return (
    <section className="testimonial-homepage h-[1267px] py-15 ">
      <div className="flex gap-[60px] flex-col justify-center items-center h-full w-[80%] mx-auto ">
        <div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center text-center w-[780px] max-md:w-[90%] max-md:mx-auto mb-[25px]">
              <img
                src={ratting}
                alt=""
        ...
        <div className="flex gap-[62px] flex-wrap max-md:gap-8 items-center justify-center">
