...
import { Button, Paragraf, Title } from "../Elements";

const AboutComp = () => {
  return (
    <section className="bg-primary-7 flex flex-1 flex-wrap justify-center gap-12  items-center text-primary-1 py-20">
      {/* left */}
      <div className="w-[600px] max-md:w-[480px]">
        <img src={image} alt="" />
      </div>
      {/* right Card */}
      <div className="flex flex-col w-[700px] max-md:w-auto max-md:mx-8 gap-[46px] max-md:items-center">
        {/* Top */}
