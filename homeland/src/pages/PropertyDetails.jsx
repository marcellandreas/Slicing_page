          ...
          <div className="flex flex-col items-start gap-8 lg:flex-row">
            ...
            >
              <div className="flex items-center gap-x-4 mb-8 ">
                <div className="w-20 h-20 p-1 border border-grat-300 rounded-full">
                  <img src={house.agent.image} alt="" />
                </div>
                <div>
                  <div className="font-bold text-lg ">{house.agent.name}</div>
                  <Link to="" className="text-violet-700-sm">
                    View Listings
                  </Link>
                </div>
              </div>
              ...
              <form className="flex flex-col gap-y-4 ">
                ...
                />
                <textarea
                  className="border border-gray-300 focus:border-violet-700 outline-none resize-none w-full p-4 h-36 text-sm text-gray-400"
                  placeholder="Message*"
